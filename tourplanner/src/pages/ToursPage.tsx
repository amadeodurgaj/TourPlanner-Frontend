        ...
        <div className="mx-auto max-w-5xl p-4 md:p-8">
          {loading ? (
            ...
            <div className="flex min-h-[calc(100vh-8rem)] flex-col items-center justify-center text-center">
              ...
              <h2 className="text-xl font-semibold text-foreground mb-2">No tour selected</h2>
              ...
              <CreateTourLogDialog
                ...
                onSubmit={async (data) => {
                  if (logState.editingLog) {
                    const ok = await logActions.updateLog(selectedTour.id, logState.editingLog.id, data);
